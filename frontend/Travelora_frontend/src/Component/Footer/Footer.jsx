        ...
        <footer className="footer footer-center bg-black text-white rounded p-10">
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    <a href='https://www.linkedin.com/in/imtiaz-ahmed-25a357201?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'>
                    ...
                    <a href="https://github.com/ImtiazAhmed01">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 50 50" className="fill-current">
                    ...
                    <a href='https://www.facebook.com/imtiaz.ahmedar'>
                        <svg
            ...
            <aside>
                <p>Copyright © {new Date().getFullYear()} - All right reserved by Travelora Ltd</p>
            </aside>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black text-[#3F0113] bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
                        ...
                        <p className="mb-4">
                            At Travelora, we value your privacy. This Privacy Policy outlines how we collect,
                        ...
                        <button className="mt-4 px-4 py-2 bg-[#52C960] text-white rounded" onClick={() => setIsModalOpen(false)}>Close</button>
                    </div>
                </div>
            )}
        </footer>
